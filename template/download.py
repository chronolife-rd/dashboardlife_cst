...
from automatic_reports.plot_images import plot_images_new
...
def data_report_pdf():
    ...
    cst_data_indicators             = st.session_state.chronolife_indicators  
    ...
    alerts_dict = cst_data_indicators['anomalies']
    
    # Plot and save graphs
    plot_images_new(cst_data_indicators, date)
